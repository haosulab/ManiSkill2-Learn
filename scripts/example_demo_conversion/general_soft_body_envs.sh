...
--traj-path demos/v0/soft_body/$ENV/trajectory.h5 \
--save-traj \
...
--env-name=$ENV \
--num-procs=4 \
--traj-name=../ManiSkill2/demos/v0/soft_body/$ENV/trajectory.none.pd_ee_delta_pose.h5 \
--json-name=../ManiSkill2/demos/v0/soft_body/$ENV/trajectory.none.pd_ee_delta_pose.json \
--output-name=../ManiSkill2/demos/v0/soft_body/$ENV/trajectory.none.pd_ee_delta_pose_pointcloud.h5 \
...
--traj-name=../ManiSkill2/demos/v0/soft_body/$ENV/trajectory.none.pd_ee_delta_pose.h5 \
--json-name=../ManiSkill2/demos/v0/soft_body/$ENV/trajectory.none.pd_ee_delta_pose.json \
--output-name=../ManiSkill2/demos/v0/soft_body/$ENV/trajectory.none.pd_ee_delta_pose_rgbd.h5 \
--control-mode=pd_ee_delta_pose \
--max-num-traj=-1 \
--obs-mode=rgbd \
--reward-mode=dense