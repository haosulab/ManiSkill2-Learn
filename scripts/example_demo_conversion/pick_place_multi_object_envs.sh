...
--traj-path demos/rigid_body_envs/$ENV/trajectory_merged.h5 \
--save-traj \
...
--source-file ../ManiSkill2/demos/rigid_body_envs/$ENV/trajectory_merged.none.pd_ee_delta_pose_pointcloud.h5 \
--target-file ../ManiSkill2/demos/rigid_body_envs/$ENV/trajectory_merged.none.pd_ee_delta_pose_pointcloud_shuffled.h5

# Shuffle rgbd demos 
python tools/shuffle_demo.py \
--source-file ../ManiSkill2/demos/rigid_body_envs/$ENV/trajectory_merged.none.pd_ee_delta_pose_rgbd.h5 \
--target-file ../ManiSkill2/demos/rigid_body_envs/$ENV/trajectory_merged.none.pd_ee_delta_pose_rgbd_shuffled.h5