...
python maniskill2_learn/apis/run_rl.py configs/mfrl/dapg/maniskill2_pn.py \
            --work-dir ./logs/dapg_picksingleycb_pointcloud --gpu-ids 0 --sim-gpu-ids 1 \
            ...
            "agent_cfg.demo_replay_cfg.buffer_filenames=../ManiSkill2/demos/rigid_body_envs/PickSingleYCB-v0/trajectory_merged.none.pd_ee_delta_pose_pointcloud.h5" \
