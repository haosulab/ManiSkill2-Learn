...
--work-dir ./logs/bc_excavate_rgbd --gpu-ids 0 \
...
"replay_cfg.buffer_filenames=../ManiSkill2/demos/v0/soft_body/Excavate-v0/trajectory.none.pd_ee_delta_pose_rgbd.h5" \
